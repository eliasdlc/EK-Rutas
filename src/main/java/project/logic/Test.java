...
public class Test {
    ...
    public static void main (String[] args) {
        ...
        Route route6 = new Route(node6, node7, "tal6", "6", 3, LocalTime.of(0, 18, 0), 35, 10);  // 18 minutos
        Route route7 = new Route(node1, node7, "tal7", "7", 5, LocalTime.of(0, 30, 0), 5, 1);    // 30 minutos
        ...
        Route route6reverse = new Route(node7, node6, "tal6", "6", 13, LocalTime.of(0, 18, 0), 35, 10); // 18 minutos
        Route route7reverse = new Route(node7, node1, "tal7", "7", 5, LocalTime.of(0, 30, 0), 5, 1);    // 30 minutos
